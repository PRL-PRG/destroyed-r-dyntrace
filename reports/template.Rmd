...
store <- function(table) function(...) log_line_to_csv(file.path(aggregate_data, paste(table, "csv", sep=".")), name=name, ...)
...
specific.calls <- get_function_calls("^<anonymous>$", "eval", "force", "delayAssign", "return", "<-", "assign", "print") 
